...
class EDIT(QMainWindow):
    ...
    def set_dock(self):
        ...
        zm3 = resource_path(f"back.png")
        self.btn_cancel = QPushButton("")
        self.btn_cancel.setIcon(QtGui.QIcon(zm3))
